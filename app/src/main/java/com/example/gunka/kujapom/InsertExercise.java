        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Integer.parseInt(String.valueOf(EdtName.length()))==0||Integer.parseInt(String.valueOf(EdtCal.length()))==0){
                    ...
                    String Extype = "2";
                    if(new String(String.valueOf(type.getSelectedItem())).equals("การออกกำลัง")){
                        Extype = "1";
                    }
                    new TheTask().execute("http://10.16.68.253/kexercise.php",EdtName.getText().toString(),Extype,EdtCal.getText().toString());
    ...
    class TheTask extends AsyncTask<String,String,String>
    {
        ...
        protected String doInBackground(String... params) {
            try
            {
                ...
                nameValuePairs.add(new BasicNameValuePair("ExType", params[2]));
                ...
                if(entity != null){
                    ...
                    Toast.makeText(getApplicationContext(), "เพิ่มข้อมูลสำเร็จ", Toast.LENGTH_LONG).show();
